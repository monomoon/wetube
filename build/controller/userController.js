...
function () {
  ...
  regeneratorRuntime.mark(function _callee5(req, res) {
    var _req$body3, currentPassword, newPassword, newPassword2;

    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _req$body3 = req.body, currentPassword = _req$body3.currentPassword, newPassword = _req$body3.newPassword, newPassword2 = _req$body3.newPassword2;
            _context5.prev = 1;
